...
public class ViewFadeAnimator {
    ...
    public ViewFadeAnimator(TextView textV, String[] textList)
    {
        this(textV,700,1000,3000, textList);
    }
    public ViewFadeAnimator(TextView textView,
                            int fadeEffectDuration,
                            int delayDuration,
                            int displayLength,
                            String[] textList )
