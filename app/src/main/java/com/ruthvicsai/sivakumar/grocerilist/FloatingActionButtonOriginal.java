 ...
 */
public class FloatingActionButtonOriginal extends FrameLayout {
     ...
     * @param contentParams
     */
    public FloatingActionButtonOriginal(Context context, ViewGroup.LayoutParams layoutParams, int theme,
         ...
         */
//------------------------------REMEMBER TO MAKE THIS PROPER--------------------------------------------------------------
        if(backgroundDrawable == null) {
            if(theme == THEME_LIGHT)
                backgroundDrawable = context.getResources().getDrawable(R.drawable.red_dark_fabxxhdpi);
            else
                backgroundDrawable = context.getResources().getDrawable(R.drawable.red_dark_fabxxhdpi);
        }
    ...
    /**
     * A builder for {@link FloatingActionButtonOriginal} in conventional Java Builder format
     */
    public static class Builder {
        ...
        public Builder(Context context) {
            ...
            int margin_bottom = context.getResources().getDimensionPixelSize(R.dimen.fab_margin);
            LayoutParams layoutParams = new LayoutParams(size, size, Gravity.BOTTOM | Gravity.RIGHT);
            layoutParams.setMargins(margin, margin, margin, margin_bottom);
            setLayoutParams(layoutParams);
            setTheme(FloatingActionButtonOriginal.THEME_LIGHT);
            setPosition(FloatingActionButtonOriginal.POSITION_BOTTOM_RIGHT);
        ...
        public FloatingActionButtonOriginal build() {
            return new FloatingActionButtonOriginal(context,
                                           layoutParams,
                                           theme,
                                           backgroundDrawable,
                                           position,
