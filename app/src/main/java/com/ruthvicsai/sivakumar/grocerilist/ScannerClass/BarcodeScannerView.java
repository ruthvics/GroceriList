package com.ruthvicsai.sivakumar.grocerilist.ScannerClass;
...
//import com.example.grocerilist12.R;
...
public abstract class BarcodeScannerView extends FrameLayout implements Camera.PreviewCallback  {
    ...
    /*
        mIsLaserEnabled has been set to false;
     */
    private boolean mIsLaserEnabled = false;
    @ColorInt private int mLaserColor = getResources().getColor(R.color.viewfinder_border);
    @ColorInt private int mBorderColor = getResources().getColor(R.color.scanner_border);
    ...
    /*
        this is a constructor which passes in the context and uses init() to initalize
        @param Context the context is passed into super
    */
    ...
    /*
    this is a constructor which passes in the context and uses init() to initalize
    as well as a AttributeSet, this set is then later used to set certain values of of the display
    in the try/finally part
    @param Context the context is passed into super
*/
    ...
    /*
    Initializes a ViewFinder to display the camera
    check createViewFinderView method
     */
    private void init() {
